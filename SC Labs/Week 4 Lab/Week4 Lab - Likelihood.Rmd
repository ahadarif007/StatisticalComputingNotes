...
**How to read the output:** R returns the derivative as an R expression. For example:
- `D(expression(log(t)), "t")` returns `1/t` (because the derivative of $\log(t)$ is $\frac{1}{t}$).
- `D(expression(t^3 - 2*t), "t")` returns `3 * t^2 - 2` (the power rule!).
